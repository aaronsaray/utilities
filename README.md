...
Run `laravel/artisan podcast:prepare` after you've placed your MP3 file in `laravel/storage/podcast`. It will prompt you to confirm which file and what the title is. All generated files will be placed in the same directory.
